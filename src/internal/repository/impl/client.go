...
func (c *ClientRepository) UpdateByID(conn abstract.IDBConnection, client *domain.Client) error {
	db := conn.Get().(*gorm.DB)
	...
	return db.Model(&model.BusinessOwner{}).
		...
		Updates(map[string]interface{}{
			...
			"last_name":     clientDAO.LastName,
			"middle_name":   clientDAO.MiddleName,
			"phone_number":  clientDAO.PhoneNumber,
